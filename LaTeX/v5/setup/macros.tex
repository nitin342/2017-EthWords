...
\newcommand{\HashN}[2]{\mathsf{H}^{#1}(#2)}
...
% = = = Name
\newcommand{\EthWords}{\textsf{EthWords}\xspace}
\newcommand{\ew}{\textsf{EthWord}\xspace}
\newcommand{\eww}{\textsf{EthWord}\xspace}
\newcommand{\pw}{\textsf{PayWord}\xspace}
\newcommand{\fifty}{\textsf{Pay50}\xspace}
\newcommand{\eth}{\texttt{ETH}\xspace}
\newcommand{\take}{PayTaker\xspace}
\newcommand{\make}{PayMaker\xspace}
